      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <Reveal className="mb-10 max-w-2xl">
          ...
          <h2 className="mt-2 text-3xl font-bold tracking-normal sm:text-4xl">
            Limpieza pensada para el ritmo del hogar.
          </h2>
        </Reveal>
        <Reveal childSelector="[data-benefit-card]" className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {benefits.map((benefit, index) => {
            ...
            return (
              <Card
                ...
                data-benefit-card
                data-motion-card
                className="border-2 border-blue-100 bg-[#f8fcff] shadow-sm transition hover:-translate-y-1 hover:border-cyan-300 hover:shadow-md"
              >
